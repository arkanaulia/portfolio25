...
export default function Works() {
        ...
        cards.forEach((card, i) => {
          ...
          gsap.to(card, {
            scrollTrigger: {
              ...
              end: parlistconRefs.current[idx + 1]
                ? "top 70%"
                : "bottom bottom",
              scrub: true,
            },
  ...
  return (
    <div className="con relative" ref={rootRef}>
      ...
      {[
        {
          title: "Dev Projects",
          classSuffix: 1,
          images: ["/img-5.webp", "/img-6.webp", "/emr.webp"],
        },
        {
          title: "UX Projects",
          classSuffix: 2,
        ...
        },
        {
          title: "3D Projects",
          classSuffix: 3,
          images: ["/sicepat.webp", "/holy.webp", "/yarsi.webp"],
        },
        {
        ...
        // Determine if this section's text should sit on the right side during desktop view
        const isTextOnRight = classSuffix % 2 === 0 && classSuffix !== 3;
        ...
        return (
          ...
          >
            {/* The Text Block - Tailwind "order" classes handle the desktop placement */}
            <div
              ref={addToListsecRefs}
              className={`listsec${classSuffix} w-full md:w-1/2 flex justify-center items-center h-32 md:h-96 mb-4 md:mb-0 ${isTextOnRight ? "md:order-last md:mt-0 mt-4" : ""
                }`}
            >
